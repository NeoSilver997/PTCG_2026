...
const EFFECT_TAG_COLORS: Record<string, string> = {
  // ── Draw / Search ──────────────────────────────────────
  '少量抽卡':       '#a5f3fc',  // cyan-200  — draw 1 card
  '抽卡效果':       '#06b6d4',  // cyan-500  — draw 2-3 cards
  '大量抽卡':       '#0ea5e9',  // sky-500   — draw 3+
  '搜索效果':       '#10b981',  // emerald-500
  '最大傷害':       '#f43f5e',  // rose-500  — very high ceiling variable damage
  ...
  // ── Special (from specialEffectTags) ───────────────────
  ...
  // ── Manual / custom tags ───────────────────────────────
  '放置基礎寶可夢': '#4ade80',  // green-400  — deck-search → bench Basic
  '附上搜索能量':   '#fb923c',  // orange-400 — attach / search Energy
};
